...
public class HeartIcon implements IHUDElement {
    ...
    public Texture getTexture() {
        ...
        if ( state == 3 )
            ...
            return new Texture("./assets/textures/ui/ui_heart_half.png");
        else
            return new Texture("./assets/textures/ui/ui_heart_empty.png");
    }
    ...
    public void calculateState() {
        ...
        if ( temp_current == temp_max )
            state = 3;
        else if ( temp_current < temp_max && temp_current > 0 )
            state = 2;
        else
            state = 1;
    }

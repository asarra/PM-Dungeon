...
/**
 * Klasse zur Darstellung des Spielers Diese Klasse besitzt Eigenschaften wie Lebenspunkte,
 * Geschwindigkeit, Blickrichtung, und EXPLevel.
 */
public class Hero extends GameActor {
  ...
  private final ArrayList<GameQuest> quests;
  public ArrayList<GameItem> itemsToAdd = new ArrayList<>();
  ...
  public Hero() {
    ...
    idle.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_f0.png"));
    idle.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_f1.png"));
    idle.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_f2.png"));
    idle.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_f3.png"));

    idleLeft.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_left_f0.png"));
    idleLeft.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_left_f1.png"));
    idleLeft.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_left_f2.png"));
    idleLeft.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_idle_anim_left_f3.png"));

    right.add(
        new Texture("assets/textures/characters/playercharacters/knight/knight_m_run_anim_f0.png"));
    right.add(
        new Texture("assets/textures/characters/playercharacters/knight/knight_m_run_anim_f1.png"));
    right.add(
        new Texture("assets/textures/characters/playercharacters/knight/knight_m_run_anim_f2.png"));
    right.add(
        new Texture("assets/textures/characters/playercharacters/knight/knight_m_run_anim_f3.png"));

    left.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_run_anim_left_f0.png"));
    left.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_run_anim_left_f1.png"));
    left.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_run_anim_left_f2.png"));
    left.add(
        new Texture(
            "assets/textures/characters/playercharacters/knight/knight_m_run_anim_left_f3.png"));
  ...
  public void notifyQuests() {
    for (GameQuest quest : quests) {
      quest.update();
    }
    quests.removeIf(GameQuest::isCompleted);
  }

  public ArrayList<GameQuest> getQuests() {
    return quests;
  }
  ...
  public void update() {
    ...
    if (this.targetPoint != null) {
      ...
      if ((Math.round(this.position.x) == Math.round(this.targetPoint.x)
          & Math.round(this.position.y) == Math.round(this.targetPoint.y))) {
    ...
    if (inventoryOpen) {
      ...
      if (Gdx.input.isKeyJustPressed(Input.Keys.O)) {
        if (!quests.isEmpty()) {
          ...
          for (GameQuest quest : quests) {
            questInfo.append(quest.toString());
          }
  ...
  public void updateItemsToAdd() {
    while (!itemsToAdd.isEmpty() && !inventory.isFull()) {
      inventory.addItem(itemsToAdd.get(0));
      itemsToAdd.remove(0);
    }
  }
  ...
  /**
   * getInventory() und getInventoryOpen() existieren, damit man das Inventarfenster bedienen zeigen
   * kann
   */
  ...
  public void addQuest(GameQuest quest) {
    if (!quests.contains(quest)) {
      quests.add(quest);
    }
  }

  public void removeQuest(GameQuest quest) {
    quests.remove(quest);
  }

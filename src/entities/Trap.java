...
/**
 * Klasse zur Darstellung einer Falle im Spiel
 * Fallen spawnen in zufälligen Positionen im Dungeon
 * über die Eigenschaft active lässt sich die Falle scharfstellen bzw entschärfen
 * über die Eigenschaft hidden lässt sich die Falle sichtbar oder unsichtbar spawnen
 */
public class Trap extends GameActor {
    ...
    /**
     * eine Arraylist wird mit den einzelnen Texturen belegt um damit die Animation der Falle zur erzeugen
     */
    public Trap() {
